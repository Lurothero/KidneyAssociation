...
QString Patient::getUrineProblemDescription()
{
    return urineProblemDescription;
}
...
void Patient::setUrineProblemDescription(QString problemText)
{
    urineProblemDescription = problemText;
}
