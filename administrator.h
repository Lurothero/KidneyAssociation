...
public:
    ...
    friend DeskEmployee* UserLibrary::findDeskEmployee(int id, string name);
    ...
    friend Administrator* UserLibrary::findAdministrator(int id, string name);
    ...
    friend Doctor* UserLibrary::findDoctor (int id, string name);
    ...
    friend Appointment* AppointmentLibrary::findAppointment(int id, string name);
